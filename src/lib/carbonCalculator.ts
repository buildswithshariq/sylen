...
import { AssessmentData, CarbonBreakdown } from "@/types";
import {
  TRANSPORT_FACTORS,
 ...
 */
export function calculateLifestyleEmissions(
  ...
  const shoppingEmissions =
    SHOPPING_EMISSIONS[shoppingFrequency] ?? SHOPPING_EMISSIONS.monthly;

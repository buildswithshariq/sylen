...
export default function PositiveImpactSummary({ totalEmissions, comparisonToAverage, className = '' }: PositiveImpactSummaryProps) {
  ...
  return (
    <GlassCard className={`p-6 sm:p-8 ${className}`}>
      <h3 className="text-lg font-bold text-stone-800 mb-6">Your Positive Impact</h3>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        >
          ...
          <p className="text-xs text-stone-500 font-medium mb-1 uppercase tracking-wider">Annual Footprint</p>
          <p className="text-xl font-bold text-emerald-800">
            <AnimatedCounter value={totalEmissions} duration={2000} suffix=" kg" />
          </p>
        </motion.div>
        ...
        >
          <div className="text-2xl mb-1">🌲</div>
          <p className="text-xs text-emerald-700/70 font-medium mb-1 uppercase tracking-wider">Trees Equivalent</p>
        ...
        >
          ...
          <p className="text-xs text-sky-700/70 font-medium mb-1 uppercase tracking-wider">CO₂ Prevented</p>
          <p className="text-xl font-bold text-sky-700">
            <AnimatedCounter value={preventedEmissions} duration={2000} suffix=" kg" />
          </p>
        </motion.div>
      </div>

      <p className="text-sm text-stone-500 mt-6 text-center leading-relaxed">
        By keeping your emissions {Math.abs(comparisonToAverage)}% below the average, you are actively participating in global climate mitigation. 
      </p>
    </GlassCard>
  );
}

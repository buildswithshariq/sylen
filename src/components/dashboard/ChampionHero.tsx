    ...
    >
      <div className="text-center">
        ...
        <p className="mt-2 text-sm text-stone-600 leading-relaxed max-w-[280px]">
          Congratulations! You are already operating at an exceptional
          sustainability level.
        </p>
      </div>

      <ScoreRing score={score} label="Top Tier" size={180} strokeWidth={10} />
      ...
      >
        <Badge text="Climate Champion" variant="success" icon="🏅" />

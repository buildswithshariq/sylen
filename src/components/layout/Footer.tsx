      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 mb-20">
          ...
          <div className="lg:col-span-5 space-y-8 pr-0 lg:pr-12">
            ...
            <div className="space-y-4">
              ...
              <p className="text-stone-500 text-sm leading-relaxed max-w-[320px]">
                AI-powered sustainability intelligence platform helping people understand, track, and improve their environmental impact.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-12 sm:gap-8">
            ...
            {/* Quick Links */}
            <div>
              <h4 className="font-semibold text-stone-900 mb-6 text-xs tracking-widest uppercase">Quick Links</h4>
              <ul className="space-y-4">
                {['Home', 'Dashboard', 'Assessment', 'Resources'].map((item) => (
                  <li key={item}>
                    <Link 
            ...
            {/* Learn */}
            <div>
              <h4 className="font-semibold text-stone-900 mb-6 text-xs tracking-widest uppercase">Learn</h4>
              <ul className="space-y-4">
                {[
                  { name: 'EPA Calculator', url: 'https://www.epa.gov/ghgemissions/carbon-footprint-calculator' },
                  { name: 'WWF Calculator', url: 'https://footprint.wwf.org.uk' },
            ...
            <div className="col-span-2 sm:col-span-1">
              <h4 className="font-semibold text-stone-900 mb-6 text-xs tracking-widest uppercase">Connect</h4>
              <ul className="space-y-4">
                <li>
                  <a 
        ...
        <div className="pt-8 mt-8 border-t border-stone-200 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <p className="text-sm font-medium text-stone-500 flex items-center gap-1.5">
            Made with <motion.span whileHover={{ scale: 1.2, rotate: 10 }} className="inline-block cursor-default">🌱</motion.span> for a more sustainable future
          </p>
        </div>
      </div>
    </footer>

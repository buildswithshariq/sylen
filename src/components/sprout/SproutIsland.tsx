...
export type TreeTier = 'sapling' | 'young' | 'growing' | 'thriving' | 'champion';
...
export default function SproutIsland({ tier }: SproutIslandProps) {
  ...
  const canopyLevel = tier === 'sapling' ? 0 
                    : tier === 'young' ? 1 
                    : tier === 'growing' ? 2 
                    : tier === 'thriving' ? 3 
                    : 4;
  ...
  return (
    <div className="relative w-24 h-28 sm:w-32 sm:h-36 select-none pointer-events-none drop-shadow-xl transition-all duration-300">
      <svg width="100%" height="100%" viewBox="0 0 112 128" className="overflow-visible">
        <defs>
          ...
          <filter id="championGlow" x="-20%" y="-20%" width="140%" height="140%">
        ...
        <g transform="translate(0, 10)">
          ...
          />
          {/* Grass details */}
          <path d="M 36 92 Q 40 88 44 92" stroke="#10B981" strokeWidth="1.5" strokeLinecap="round" fill="none" opacity="0.6"/>
          <path d="M 76 96 Q 74 92 72 96" stroke="#047857" strokeWidth="1.5" strokeLinecap="round" fill="none" opacity="0.6"/>
        </g>
        ...
        >
          ...
          {tier === 'sapling' && (
            <g>
              <path d="M 56 105 Q 54 90 56 80" stroke="url(#grassGrad)" strokeWidth="2.5" strokeLinecap="round" fill="none" />
              <motion.path 
